...
//@property(nonatomic,strong)NSMutableArray *merchantModels;
...
//    [_merchantModels removeAllObjects];
    ...
    WeakSelf
    [HttpRequest lrw_getWithURLString:[NSString stringWithFormat:@"%@order/myorders?status=%ld&pageSize=50&pageIndex=1",httpHead,_orderState] parameters:nil success:^(id responseObject) {
